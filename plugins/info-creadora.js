...
lugar = official[0][0] == String(contact[0]) ? 'EmilianoST' : official[1][0] == String(contact[0]) ? 'EmilianoST' : official[2][0] == String(contact[0]) ? 'Sisked' : official[3][0] == String(contact[0]) ? 'EmilianoST' : country === '' ? lenguajeGB.smsContacto7() : country
